...
IF(PLUS_USE_OMMO)
  # Pass PLUS_Ommo_DIR and Ommo_DIR to PlusLib so it knows where Ommo is located
  # Use PLUS_Ommo_DIR if set, otherwise use the expected ExternalProject location
  IF(NOT PLUS_Ommo_DIR)
    SET(PLUS_Ommo_DIR "${CMAKE_BINARY_DIR}/Deps/Ommo-bin")
  ENDIF()
  LIST(APPEND PLUSBUILD_ADDITIONAL_SDK_ARGS
    -DPLUS_Ommo_DIR:PATH=${PLUS_Ommo_DIR}
    -DOmmo_DIR:PATH=${PLUS_Ommo_DIR}
    )
ENDIF()
...
IF(PLUS_USE_OMMO)
  # Ommo must be built before PlusLib
  LIST(APPEND PlusLib_DEPENDENCIES Ommo spdlog gRPC)
  # Force Ommo to look in the shared externals directory for its dependencies
  LIST(APPEND PlusLib_ADDITIONAL_PROJECT_ARGS
    -DCMAKE_PREFIX_PATH:PATH=${PLUS_EXTERNALS_PREFIX}
    -DProtobuf_DIR:PATH=${PLUS_EXTERNALS_PREFIX}/lib/cmake/protobuf
    -DgRPC_DIR:PATH=${PLUS_EXTERNALS_PREFIX}/lib/cmake/grpc
    -Dspdlog_DIR:PATH=${PLUS_EXTERNALS_PREFIX}/lib/cmake/spdlog
  )
ENDIF()
...
ExternalProject_Add(PlusLib
  ...
  CMAKE_ARGS
    ...
    -DPLUS_USE_OMMO:BOOL=${PLUS_USE_OMMO}
